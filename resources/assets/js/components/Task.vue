<template>
  <div class="questions__form">
    ...
    <list-variants v-if="!isTaskInvalid" :variants="taskData.variants" :task-id="taskData.id"/>
    <div class="form-group questions__wrap">
      <label class="control-label">Шаблоны</label>
      <div class>
        <select multiple class="form-control" @change="changeTemplates" v-model="selectedTemplates">
          <option
...
export default {
  components: {
    'list-variants': require('./ListVariants.vue').default
  },
